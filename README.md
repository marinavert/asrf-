...
- Possibility to use the concatenation of the features extracted by ResNet-50 with original I3D ones. (create a new branch ? - everything is in comments right now)
- Using regular cross-entropy loss function in this case.
