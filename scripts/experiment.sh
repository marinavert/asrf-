...
python evaluate.py ./result/gtea/dataset-gtea_split-2/config.yaml --refinement_method refinement_with_boundary
python evaluate.py ./result/gtea/dataset-gtea_split-3/config.yaml --refinement_method refinement_with_boundary
python evaluate.py ./result/gtea/dataset-gtea_split-4/config.yaml --refinement_method refinement_with_boundary
...
python save_pred.py /home/ubuntu/local/asrf//result/gtea/dataset-gtea_split-1/config.yaml
python save_pred.py /home/ubuntu/local/asrf//result/gtea/dataset-gtea_split-2/config.yaml
python save_pred.py /home/ubuntu/local/asrf//result/gtea/dataset-gtea_split-3/config.yaml
python save_pred.py /home/ubuntu/local/asrf//result/gtea/dataset-gtea_split-4/config.yaml

# # convert array to image
python utils/convert_arr2img.py /home/ubuntu/local/asrf//result/gtea/dataset-gtea_split-1/predictions
python utils/convert_arr2img.py /home/ubuntu/local/asrf//result/gtea/dataset-gtea_split-2/predictions
python utils/convert_arr2img.py /home/ubuntu/local/asrf//result/gtea/dataset-gtea_split-3/predictions
python utils/convert_arr2img.py /home/ubuntu/local/asrf//result/gtea/dataset-gtea_split-4/predictions