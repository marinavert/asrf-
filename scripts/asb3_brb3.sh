...
python ./utils/make_configs.py --root_dir ./result/gtea --dataset gtea --split 1 2 3 4 --n_stages_asb 3 --n_stages_brb 3 --device 0

## stages_asb = 3, stages_brb = 3
python train.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-1_device-0/config.yaml
python evaluate.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-1_device-0/config.yaml --refinement_method refinement_with_boundary
python save_pred.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-1_device-0/config.yaml
python utils/convert_arr2img.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-1_device-0/predictions

python train.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-2_device-0/config.yaml
python evaluate.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-2_device-0/config.yaml --refinement_method refinement_with_boundary
python save_pred.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-2_device-0/config.yaml
python utils/convert_arr2img.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-2_device-0/predictions

python train.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-3_device-0/config.yaml
python evaluate.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-3_device-0/config.yaml --refinement_method refinement_with_boundary
python save_pred.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-3_device-0/config.yaml
python utils/convert_arr2img.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-3_device-0/predictions

python train.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-4_device-0/config.yaml
python evaluate.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-4_device-0/config.yaml --refinement_method refinement_with_boundary
python save_pred.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-4_device-0/config.yaml
python utils/convert_arr2img.py ./result/gtea/n_stages_asb-3_n_stages_brb-3_dataset-gtea_split-4_device-0/predictions
