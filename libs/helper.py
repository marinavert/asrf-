...
def evaluate(
    ...
    cls_acc_bf, edit_score_bf, segment_f1s_bf = scores_before_refinement.get_scores()
    cls_acc_af, edit_score_af, segment_f1s_af = scores_after_refinement.get_scores()

    wandb.log({"BF class accuracy":cls_acc_bf, "BF Edit":edit_score_bf,
    "BF F1@10":segment_f1s_bf[0], "BF F1@25":segment_f1s_bf[1], "BF F1@50":segment_f1s_bf[2],
    "AF class accuracy":cls_acc_af, "AF Edit":edit_score_af,
    "AF F1@10":segment_f1s_af[0], "AF F1@25":segment_f1s_af[1], "AF F1@50":segment_f1s_af[2],
})
    # save logs
